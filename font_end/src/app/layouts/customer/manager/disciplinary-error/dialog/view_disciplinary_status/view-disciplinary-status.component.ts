...
@Component({
  templateUrl: './view-disciplinary-status.component.html',
  styleUrls: ['./view-disciplinary-status.component.css']
})

export class ViewDisciplinaryStatusComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ViewDisciplinaryStatusComponent>,
  ...
  async ngOnInit() {
    ...
    let code = this.formDisciplinaryError.disciplinary_status.status == null ? "1" : this.formDisciplinaryError.disciplinary_status.status.code;
