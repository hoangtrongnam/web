...
@Component({
  templateUrl: './view-error-details.component.html',
  styleUrls: ['./view-error-details.component.css']
})

export class ViewErrorDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ViewErrorDetailsComponent>,
